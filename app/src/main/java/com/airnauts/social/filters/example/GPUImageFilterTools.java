...
package com.airnauts.social.filters.example;

import java.util.LinkedList;
import java.util.List;

import com.airnauts.social.R;
import com.airnauts.social.filters.*;
import android.app.AlertDialog;
import android.content.Context;
import android.content.DialogInterface;
import android.graphics.BitmapFactory;
import android.graphics.PointF;
import com.airnauts.social.filters.example.filter.*;
...
//
    ...
    private static GPUImageFilter createBlendFilter(Context context, Class<? extends GPUImageTwoInputFilter> filterClass) {
        try {
            ...
            filter.setBitmap(BitmapFactory.decodeResource(context.getResources(), R.drawable.black_circle));
            return filter;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
